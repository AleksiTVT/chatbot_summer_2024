...
class ChatBot:
    ...
    def get_response(self, question: str, previous_messages: list[dict[str,str]], attachment_type: None|str, attachment):
        ...
        print("the attachment type: ", attachment_type)
        ...
        print("previous messages appended")
        ...
        if attachment_type == None:
            ...
            print("The attachment_type is audio")
        ...
        response = self.client.chat.completions.create(
            ...
            messages=[
                ...
                },
                {
                    "role": "user",
                    "content": [
                        "Say 'HELLO' first, then give the analysis for the imgae provided",
                        {
                            "type": "image_url",
                            "image_url": {
                                "url": f"data:image/jpeg;base64,{image_data}"
